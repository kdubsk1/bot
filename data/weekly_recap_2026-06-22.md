...
**Generated:** 2026-06-29 14:17:03 ET
...
|---|---|---|---|---|---|
| Max 3 daily trades cap | 27 | 0 | 0 | —% | — |
| BTC/SOL correlation lockout | 2 | 0 | 0 | —% | — |
| Suspended setup (outcome-tracked) | 6 | 0 | 0 | —% | — |
...
- **BTC/SOL correlation lockout:** 2 events, only 0 resolved — keep watching.
- **Max 3 daily trades cap:** 27 events, only 0 resolved — keep watching.


## 🎯 Weekly Conclusions

- ⚠️ Real WR this week: 12% — significantly below break-even.
  Conviction score may not be predictive. Review signal quality.
- 📊 35 shadow events this week — data forming for gate review.