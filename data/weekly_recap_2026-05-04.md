...
**Generated:** 2026-05-11 15:12:58 ET
...
|---|---|---|---|---|---|
| Suspended setup (outcome-tracked) | 84 | 0 | 0 | —% | — |
...
|---|---|---|---|---|---|
| BTC:APPROACH_RESIST | 47 | 0 | 0 | —% | — |
| BTC:BREAK_RETEST_BULL | 18 | 0 | 0 | —% | — |
| SOL:APPROACH_RESIST | 19 | 0 | 0 | —% | — |
...
_No shadow events at all this week — gates never came close to blocking anything._

## 🎯 Weekly Conclusions

- ⚠️ Real WR this week: 22% — significantly below break-even.
  Conviction score may not be predictive. Review signal quality.
- 📊 84 shadow events this week — data forming for gate review.